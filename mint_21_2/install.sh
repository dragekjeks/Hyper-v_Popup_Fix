...
#
# This script is for Linux Mint 21.2 Cinnamon to download and install XRDP+XORGXRDP via
# source.
#
...
# Add script to setup the Cinnamon session properly
...
# use the script to setup the Cinnamon session
